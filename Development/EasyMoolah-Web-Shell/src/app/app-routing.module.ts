...
const appRoutes: Routes = [
  ...
  { path: 'step-4/:jar', component: Step4Component, data: {state: 'step-4'} },
  { path: 'step-5/:jar', component: Step5Component, data: {state: 'step-5'} },
  { path: 'step-6/:jar', component: Step6Component, data: {state: 'step-6'} },
  { path: 'step-7/:jar', component: Step7Component, data: {state: 'step-7'} },
  { path: 'step-8/:jar', component: Step8Component, data: {state: 'step-8'} },
  { path: 'step-9/:jar', component: Step9Component , data: {state: 'step-9'}},
  { path: 'step-10/:jar', component: Step10Component , data: {state: 'step-10'}},
  { path: 'step-11/:jar', component: Step11Component , data: {state: 'step-11'}},
  { path: 'step-12/:jar', component: Step12Component , data: {state: 'step-12'}},
  { path: 'step-13/:jar', component: Step13Component , data: {state: 'step-13'}},
