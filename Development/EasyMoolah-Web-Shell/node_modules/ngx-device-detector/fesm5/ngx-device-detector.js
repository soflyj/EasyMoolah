...
var DeviceDetectorService = /** @class */ (function () {
    ...
    DeviceDetectorService.prototype.isMobile = function () {
        ...
        var match = Object.keys(MOBILES_RE).find(function (mobile) {
            return _this.reTree.test(_this.userAgent, MOBILES_RE[mobile]);
        });
        return !!match;
    };
    /**
    ...
    DeviceDetectorService.prototype.isTablet = function () {
        ...
        var match = Object.keys(TABLETS_RE).find(function (mobile) {
            return !!_this.reTree.test(_this.userAgent, TABLETS_RE[mobile]);
        });
        return !!match;
    };
    /**
...
export { BROWSERS, BROWSERS_RE, BROWSER_VERSIONS_RE, BROWSER_VERSIONS_RE_MAP, DEVICES, DEVICES_RE, DeviceDetectorModule, DeviceDetectorService, MOBILES_RE, OS, OS_RE, OS_VERSIONS, OS_VERSIONS_RE, ReTree, TABLETS_RE };
